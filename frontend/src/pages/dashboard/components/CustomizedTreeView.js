...
const ITEMS = [
  {
    ...
    children: [
      ...
      { id: '1.3', label: 'Acerca de', color: 'green' },
      {
        id: '1.4',
        label: 'Blog',
        children: [
          { id: '1.1.1', label: 'Anuncios', color: 'blue' },
          { id: '1.1.2', label: 'Previsión de abril', color: 'blue' },
          { id: '1.1.3', label: "Qué hay de nuevo", color: 'blue' },
  ...
  },
  {
    ...
    children: [
      { id: '2.1', label: 'Todos los productos', color: 'green' },
      {
        ...
        label: 'Categorías',
        children: [
          { id: '2.2.1', label: 'Accesorios', color: 'blue' },
          { id: '2.2.2', label: 'Celulares', color: 'blue' },
          { id: '2.2.3', label: 'Informática', color: 'blue' },
        ],
      },
      { id: '2.3', label: 'Los más vendidos', color: 'green' },
