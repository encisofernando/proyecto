...
export const columns = [
  { field: 'pageTitle', headerName: 'Título de la página', flex: 1.5, minWidth: 200 },
  {
    field: 'status',
    headerName: 'Estado',
    flex: 0.5,
  ...
  {
    field: 'eventCount',
    headerName: 'Recuento de eventos',
    headerAlign: 'right',
    align: 'right',
    flex: 1,
    minWidth: 100,
  ...
  {
    field: 'conversions',
    headerName: 'Conversiones diarias',
    flex: 1,
    minWidth: 150,
...
export const rows = [
  {
    id: 1,
    pageTitle: 'Descripción general de la página de inicio',
    status: 'Online',
    eventCount: 8345,
    users: 212423,
    viewsPerUser: 18.5,
  ...
  {
    id: 2,
    pageTitle: 'Detalles del producto - Gadgets',
    status: 'Online',
    eventCount: 5653,
    users: 172240,
    viewsPerUser: 9.7,
  ...
  {
    id: 3,
    pageTitle: 'Proceso de pago - Paso 1',
    status: 'Offline',
    eventCount: 3455,
    users: 58240,
    viewsPerUser: 15.2,
  ...
  {
    id: 4,
    pageTitle: 'Panel de perfil de usuario',
    status: 'Online',
    eventCount: 112543,
    users: 96240,
    viewsPerUser: 4.5,
  ...
  {
    id: 5,
    pageTitle: 'Listado de artículos - Noticias tecnológicas',
    status: 'Offline',
    eventCount: 3653,
    users: 142240,
    viewsPerUser: 3.1,
  ...
  {
    id: 6,
    pageTitle: 'Preguntas frecuentes - Atención al cliente',
    status: 'Online',
    eventCount: 106543,
    users: 15240,
    viewsPerUser: 7.2,
  ...
  {
    id: 7,
    pageTitle: 'Comparación de productos - Laptops',
    status: 'Offline',
    eventCount: 7853,
    users: 32240,
    viewsPerUser: 6.5,
  ...
  {
    id: 8,
    pageTitle: 'Carrito de Compras - Electrónica',
    status: 'Online',
    eventCount: 8563,
    users: 48240,
    viewsPerUser: 4.3,
  ...
  {
    id: 9,
    pageTitle: 'Confirmación de Pago - Transferencia Bancaria',
    status: 'Offline',
    eventCount: 4563,
    users: 18240,
    viewsPerUser: 2.7,
  ...
  {
    id: 10,
    pageTitle: 'Reseñas de productos - Smartphones',
    status: 'Online',
    eventCount: 9863,
    users: 28240,
    viewsPerUser: 5.1,
  ...
  {
    id: 11,
    pageTitle: 'Gestión de suscripciones - Servicios',
    status: 'Offline',
    eventCount: 6563,
    users: 24240,
    viewsPerUser: 4.8,
  ...
  {
    id: 12,
    pageTitle: 'Seguimiento de pedidos - Envíos',
    status: 'Online',
    eventCount: 12353,
    users: 38240,
    viewsPerUser: 3.5,
  ...
  {
    id: 13,
    pageTitle: 'Comentarios de los clientes - Encuestas',
    status: 'Offline',
    eventCount: 5863,
    users: 13240,
    viewsPerUser: 2.3,
  ...
  {
    id: 14,
    pageTitle: 'Configuración de cuenta - Preferencias',
    status: 'Online',
    eventCount: 7853,
    users: 18240,
    viewsPerUser: 3.2,
  ...
  {
    id: 15,
    pageTitle: 'Página de inicio de sesión - Autenticación',
    status: 'Offline',
    eventCount: 9563,
    users: 24240,
    viewsPerUser: 2.5,
  ...
  {
    id: 16,
    pageTitle: 'Promociones - Ventas de temporada',
    status: 'Online',
    eventCount: 13423,
    users: 54230,
    viewsPerUser: 7.8,
  ...
  {
    id: 17,
    pageTitle: 'Tutoriales - Guías prácticas',
    status: 'Offline',
    eventCount: 4234,
    users: 19342,
    viewsPerUser: 5.2,
  ...
  {
    id: 18,
    pageTitle: 'Publicaciones de Blog - Conocimientos Técnicos',
    status: 'Online',
    eventCount: 8567,
    users: 34234,
    viewsPerUser: 6.3,
  ...
  {
    id: 21,
    pageTitle: 'Estudios de caso - Historias de éxito',
    status: 'Offline',
    eventCount: 4567,
    users: 19345,
    viewsPerUser: 6.1,
  ...
  {
    id: 22,
    pageTitle: 'Noticias - Actualizaciones de la industria',
    status: 'Online',
    eventCount: 7856,
    users: 34567,
    viewsPerUser: 5.7,
  ...
  {
    id: 23,
    pageTitle: 'Foro - Discusiones de usuarios',
    status: 'Offline',
    eventCount: 5678,
    users: 23456,
    viewsPerUser: 4.2,
  ...
  {
    id: 24,
    pageTitle: 'Documentaciones - API Reference',
    status: 'Online',
    eventCount: 6789,
    users: 27689,
    viewsPerUser: 5.0,
  ...
  {
    id: 26,
    pageTitle: 'Comentarios - Reseñas de usuarios',
    status: 'Online',
    eventCount: 8564,
    users: 34240,
    viewsPerUser: 6.2,
  ...
  {
    id: 27,
    pageTitle: 'Perfiles - Miembros del Equipo',
    status: 'Offline',
    eventCount: 5634,
    users: 23423,
    viewsPerUser: 5.5,
  ...
  {
    id: 28,
    pageTitle: 'Notificaciones - Alertas',
    status: 'Online',
    eventCount: 6745,
    users: 27654,
    viewsPerUser: 4.9,
  ...
  {
    id: 30,
    pageTitle: 'Informes - Análisis Mensual',
    status: 'Online',
    eventCount: 7890,
    users: 34567,
    viewsPerUser: 5.9,
  ...
  {
    id: 31,
    pageTitle: 'Formación - Incorporación de empleados',
    status: 'Offline',
    eventCount: 3456,
    users: 19234,
    viewsPerUser: 6.1,
  ...
  {
    id: 32,
    pageTitle: 'Recursos - Base de conocimientos',
    status: 'Online',
    eventCount: 5678,
    users: 23456,
    viewsPerUser: 4.7,
  ...
  {
    id: 33,
    pageTitle: 'Configuración - Controles de privacidad',
    status: 'Offline',
    eventCount: 6789,
    users: 27689,
    viewsPerUser: 5.8,
  ...
  {
    id: 34,
    pageTitle: 'Integraciones - Servicios de terceros',
    status: 'Online',
    eventCount: 4567,
    users: 19345,
    viewsPerUser: 4.4,
  ...
  {
    id: 35,
    pageTitle: 'Cuenta - Información de facturación',
    status: 'Offline',
    eventCount: 7890,
    users: 34567,
    viewsPerUser: 5.4,
